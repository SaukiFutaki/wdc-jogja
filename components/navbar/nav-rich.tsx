...
import * as React from "react";
  ...
  const components: {
  ...
  }[] = [
    {
      ...
      description: "Menampilkan informasi produk seperti gambar, harga, dan tombol beli.",
    ...
    },
    {
      ...
      description: "Menampilkan daftar barang yang ditambahkan ke keranjang belanja.",
      icon: ShoppingCartIcon,
    },
    {
      title: "FAQ",
      href: "/components/faq",
      description: "Menampilkan pertanyaan dan jawaban umum seputar layanan dan produk.",
      icon: HelpCircleIcon,
    },
    {
      title: "Blog Post",
      href: "/components/blog",
      description: "Menampilkan artikel atau tutorial tentang fashion dan rework pakaian.",
      icon: FileTextIcon,
    },
    {
      title: "Subscription Form",
      href: "/components/subscription",
      description: "Formulir untuk berlangganan newsletter atau penawaran eksklusif.",
      icon: MailIcon,
    },
  ];
